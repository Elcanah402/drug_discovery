...
#Backport fractions.gcd for compatibility with older libraries
...
import numpy as np
#create a compatibility shim for  deprecated numpy attributes
#create  a compatibility layer for numpy float_ if it does not exist
